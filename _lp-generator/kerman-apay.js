 ...
 */
require('./_guard.js')('kerman-apay.js');
const fs = require('fs');
...
const FAMILY    = 'KM50';
/* FLAT OUTPUT. Commit 9763a57 flattened every live clone family to ONE .html file, so the KM50
...
const FLAT_PAGE = 'apay750usa-kerman';
const GEO       = 'US';
